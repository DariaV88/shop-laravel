      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('admin.user.index')}}">Пользователb</a></li>
      ...
      <div class="container-fluid">
       ...
       <div class="row">
        <form action="{{route('admin.users.store')}}" method="post">
          ...
          <div class="form-group">
          <select name="gender" class="custom-select form-control-border mb-3" id="exampleSelectBorder">
